<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column prop="perms" align="center" label="权限标识" width="160"/>
      <el-table-column prop="path" align="center" label="路由地址" width="120"/>
      <el-table-column prop="component" align="center" label="组件路径" width="160"/>
      <el-table-column prop="sortValue" align="center" label="排序" width="50"/>
